...
class CompleteFABView extends FrameLayout {
    ...
    private int showFinalIconDuration;

    public CompleteFABView(Context context, Drawable iconDrawable, int arcColor,
                           int showFinalIconDuration) {
        super(context);
        this.iconDrawable = iconDrawable;
        this.arcColor = arcColor;
        this.showFinalIconDuration = showFinalIconDuration;
        init();
    }
    ...
    private void animate(AnimatorSet progressArcAnimator, boolean inverse) {
        ...
        if (inverse) {
            animatorSet.setStartDelay(showFinalIconDuration);
        }
        animatorSet.start();
    }
