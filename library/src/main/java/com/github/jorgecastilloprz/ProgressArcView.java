...
import static com.github.jorgecastilloprz.AnimationUtils.SHOW_SCALE_ANIM_DELAY;
...
final class ProgressArcView extends ProgressBar {
    ...
    public ProgressArcView(Context context, int arcColor, int arcWidth, boolean roundedStroke,
        ...
        init(arcColor, arcWidth, roundedStroke, progressArcAnimationDuration);
    }

    public void init(int arcColor, int arcWidth, boolean roundedStroke,
                     ProgressArcAnimationDuration progressArcAnimationDuration) {
        setupInitialAlpha();
        ProgressArcDrawable arcDrawable =
                new ProgressArcDrawable(arcWidth, arcColor, roundedStroke,
                        progressArcAnimationDuration);
    ...
    public void stop() {
        ...
        int duration = getContext()
                .getResources().getInteger(R.integer.duration_fade_out_progress_arc_view);
        fadeOutAnim.setDuration(duration).start();
    }
    ...
    public AnimatorSet getScaleDownAnimator() {
        ...
        int duration = getContext()
                .getResources().getInteger(R.integer.duration_scale_down_progress_arc_view);
